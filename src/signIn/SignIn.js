        ...
        return (
         <div className="sign-in--wrapper">
             ...
             <div className="sign-in--form">
                ...
                <input type="text" name="mail" id="mail" placeholder=" Exemple : adresse@yahoo.fr"/> 
             </div>
             <div className="sign-in--form">
                <label for="age"> Renseigner votre date de naissance : </label>
                <input type="date" name="age" id="age" placeholder=" date de naissance"/> 
             </div>
             <div className="sign-in--form">
             ...
             <div className="sign-in--form">
                <label for="danseur"> Etes-vous danseur/danseuse ?</label> :
             ...
             <div className="sign-in--form">
                <label for="student"> Etes-vous élève à l'école de danse Mdanse78 ? </label> :
             ...
             <div className="sign-in--form">
                <label for="venu-premier"> Etes-vous venu au 1er Trophée de Rambouillet ? : </label>
            ...
            <div className="sign-in--form">
                <label for="venu-deuxieme"> Etes-vous venu au 2ème Trophée de Rambouillet ? : </label> 
                <select name="premier-trophee" id="premier-trophee">
                    <option value="oui" selected>Oui</option> 
                    <option value="non">Non</option>
                </select>
